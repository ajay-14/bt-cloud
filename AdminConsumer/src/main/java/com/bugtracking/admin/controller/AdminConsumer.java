...
import com.bugtracking.admin.dto.Bug;
import com.bugtracking.admin.dto.Employee;
import com.bugtracking.admin.dto.Project;
...
public class AdminConsumer {
	...
	public Bug getBug(@PathVariable long bugId) { 
		String endpoint = "http://bug-container:8054/bugs/" + bugId;
	...
	public List<Employee> allemployees() {
		String endpoint = "http://emp-container:8056/employees/";
	...
	public Employee getemployee(@PathVariable long empId) {
		String endpoint = "http://emp-container:8056/employees/" + empId;
	...
	public List<Project> allprojects() {
		String endpoint = "http://project-container:8055/projects/";
	...
	public Project getproject(@PathVariable long projId) {
		String endpoint = "http://project-container:8055/projects/" + projId;
